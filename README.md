...
|------|------------------------------------------|
| 1    | ![Граф запуска потоков №1](thread_graphs/1.png)  |
| 2    | ![Граф запуска потоков №2](thread_graphs/2.png)  |
| 3    | ![Граф запуска потоков №3](thread_graphs/3.png)  |
| 4    | ![Граф запуска потоков №4](thread_graphs/4.png)  |
| 5    | ![Граф запуска потоков №5](thread_graphs/5.png)  |
| 6    | ![Граф запуска потоков №6](thread_graphs/6.png)  |
| 7    | ![Граф запуска потоков №7](thread_graphs/7.png)  |
| 8    | ![Граф запуска потоков №8](thread_graphs/8.png)  |
| 9    | ![Граф запуска потоков №9](thread_graphs/9.png)  |
| 10   | ![Граф запуска потоков №10](thread_graphs/10.png) |
| 11   | ![Граф запуска потоков №11](thread_graphs/11.png) |
| 12   | ![Граф запуска потоков №12](thread_graphs/12.png) |
| 13   | ![Граф запуска потоков №13](thread_graphs/13.png) |
| 14   | ![Граф запуска потоков №14](thread_graphs/14.png) |
| 15   | ![Граф запуска потоков №15](thread_graphs/15.png) |
| 16   | ![Граф запуска потоков №16](thread_graphs/16.png) |
| 17   | ![Граф запуска потоков №17](thread_graphs/17.png) |
| 18   | ![Граф запуска потоков №18](thread_graphs/18.png) |
| 19   | ![Граф запуска потоков №19](thread_graphs/19.png) |
| 20   | ![Граф запуска потоков №20](thread_graphs/20.png) |
